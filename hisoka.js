...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
    try {
        ...
        const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "120363043511007284@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: global.fake, surface: 200, message: `♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`, orderTitle: 'WTF', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`,jpegThumbnail: global.fake}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "120363043511007284@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":`♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`, "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`, 'jpegThumbnail': global.fake}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "120363043511007284@g.us","inviteCode": "GUNNE1klKuS81EGcC0sy3K","groupName": "BotWhatsApp-BailyesMD", "caption": `♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`, 'jpegThumbnail': global.fake}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "120363043511007284@g.us" } : {}) },message: { "videoMessage": { "title":`${pushname}`, "h": `Hmm`,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': global.fake}}}
		const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `♕𖦹ʀᴏʙᴏᴛ ᴍᴏɴᴋᴇʏ ᴋɪɴɢ𖦹♕`,jpegThumbnail: global.fake}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `120363043511007284@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': global.fake, thumbnail: global.fake,sendEphemeral: true}}}
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (kuismath.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await m.reply(`🎮 Kuis Matematika  🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? kirim ${prefix}math mode\n jangan lupa masuk gc bot https://cararegistrasi.com/SDlOlq8`)
...
klik https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    ...
	    if (!roof.pilih2) hisoka.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu\n jangan lupa masuk gc bot https://cararegistrasi.com/SDlOlq8', 0)
	    }
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
            case 'sc': {
                m.reply('Script : https://cararegistrasi.com/SDlOlq8\n\n Dont Forget Give Star\n\nDonate : 6288293524506 (Link Aja)\nSafeLinkU : https://cararegistrasi.com/uBXth2LRWf\n\n Dont Forget Donate')
            }
            break            
	    case 'family100': {
...
break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://cararegistrasi.com/uBXth2LRWf'
                                }
                            }, {
                                urlButton: {
                      ...
                      hisoka.send5ButImg(i, txt, hisoka.user.name, global.fake, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      hisoka.send5ButImg(yoi, txt, hisoka.user.name, global.fake, btn)
		}
...
let btn = [{
                      ...
                      hisoka.send5ButImg(m.chat, txt, hisoka.user.name, global.fake, btn)
                      }
            break
            case 'setmenu': {
            if (!isCreator) throw mess.owner
...
`
                let btn = [{
                        ...
                        hisoka.send5ButImg(m.chat, anu, hisoka.user.name, global.fake, btn)
                        } else if (setbot.templateGif) {
                        hisoka.send5ButGif(m.chat, anu, hisoka.user.name, global.video, btn)
                        } else if (setbot.templateVid) {
                        hisoka.send5ButVid(m.chat, anu, hisoka.user.name, global.video, btn)
